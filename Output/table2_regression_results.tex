...
\\
\hline
\multicolumn{6}{p{11cm}}{\footnotesize \textit{Notes:} Robust (HC1) standard errors in parentheses. STMT is expressed in basis points; $\beta$ represents the asset response to a 1 bp statement surprise. Exchange rate responses are small and imprecisely estimated in daily data. Sample: FOMC announcement days, 1994--2026. *** $p<0.01$, ** $p<0.05$, * $p<0.10$.} \\
\end{tabular}
\end{table}
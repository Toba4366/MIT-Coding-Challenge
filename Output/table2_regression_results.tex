...
\\
\multicolumn{6}{l}{\textit{Panel C: Exchange Rates (\% log return)}} \\[2pt]
...
\\
\hline
\multicolumn{6}{p{11cm}}{\footnotesize \textit{Notes:} Robust (HC1) standard errors in parentheses. $\beta$ represents the response to a 1 basis point STMT surprise. Sample: FOMC announcement days, 1994--2026. *** $p<0.01$, ** $p<0.05$, * $p<0.10$.} \\
\end{tabular}
\end{table}
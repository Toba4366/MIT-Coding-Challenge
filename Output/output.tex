...
\input{table2_regression_results.tex}

\clearpage
% ----------------------------------------------------------------------------
\section{Table 2a: NFA by Country}
\input{table2a_nfa_by_country.tex}

\clearpage
% ----------------------------------------------------------------------------
\section{Table 2b: Treasury Response}
\input{table2b_treasury_response.tex}

\clearpage
% ----------------------------------------------------------------------------
\section{Table 2c: FX Response}
\input{table2c_fx_response.tex}

\clearpage
% ----------------------------------------------------------------------------
\section{Table 3: NFA Panel Regression}
\input{table3_nfa_panel.tex}

\clearpage
% ----------------------------------------------------------------------------
\section{Table 4: Time Variation (Post-GFC)}
\input{table4_time_variation.tex}

\clearpage
% ----------------------------------------------------------------------------
\section{Table 5: VIX Stress Interaction}
\input{table5_vix_stress.tex}

\clearpage
% ----------------------------------------------------------------------------
\section{Table 8: Placebo Test}
\input{table8_placebo.tex}
...
This document contains the full methodology, results, and interpretation of the analysis.

\vspace{1em}
\noindent\textbf{Code Repository:} All source code is available at:\\
